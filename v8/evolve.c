...
void evolve_64_even(UInt64 *rule, UInt64 src, UInt64 *dst) {
    UInt64 result = 0;
    UInt64 qind0 = (src & 255ULL);
    UInt64 res0 = (rule[qind0]);
    result |= (res0 & 255ULL);
    UInt64 qind1 = ((src & 65280ULL) >> 8);
    UInt64 res1 = (rule[qind1]);
    result |= ((res1 & 255ULL) << 8);
    UInt64 qind2 = ((src & 16711680ULL) >> 16);
    UInt64 res2 = (rule[qind2]);
    result |= ((res2 & 255ULL) << 16);
    UInt64 qind3 = ((src & 4278190080ULL) >> 24);
    UInt64 res3 = (rule[qind3]);
    result |= ((res3 & 255ULL) << 24);
    UInt64 qind4 = ((src & 1095216660480ULL) >> 32);
    UInt64 res4 = (rule[qind4]);
    result |= ((res4 & 255ULL) << 32);
    UInt64 qind5 = ((src & 280375465082880ULL) >> 40);
    UInt64 res5 = (rule[qind5]);
    result |= ((res5 & 255ULL) << 40);
    UInt64 qind6 = ((src & 71776119061217280ULL) >> 48);
    UInt64 res6 = (rule[qind6]);
    result |= ((res6 & 255ULL) << 48);
    UInt64 qind7 = ((src & 18374686479671623680ULL) >> 56);
    UInt64 res7 = (rule[qind7]);
    result |= ((res7 & 255ULL) << 56);
    *dst = result;
}
